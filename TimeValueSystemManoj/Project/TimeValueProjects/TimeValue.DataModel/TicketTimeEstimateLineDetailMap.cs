...
namespace TimeValue.DataModel
{
    ...
    public partial class TicketTimeEstimateLineDetailMap
    {
        public long PkTicketTimeEstimateLineDetailMapId { get; set; }
        public Nullable<long> FkEstimateLineDetailId { get; set; }
        public Nullable<long> FkTicketTimeId { get; set; }
