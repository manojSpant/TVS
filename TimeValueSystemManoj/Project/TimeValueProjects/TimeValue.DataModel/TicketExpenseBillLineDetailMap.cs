...
namespace TimeValue.DataModel
{
    ...
    public partial class TicketExpenseBillLineDetailMap
    {
        public long PkTicketExpenseBillLineDetailMapId { get; set; }
        public Nullable<long> FkBillLineDetailId { get; set; }
        public Nullable<long> FkTickeExpenseId { get; set; }
