...
namespace TimeValue.DataModel
{
    ...
    public partial class TicketDisbursmentEstimateLineDetailMap
    {
        public long PkTicketDisbursementEstimateLineDetailMapId { get; set; }
        public Nullable<long> FkEstimateLineDetailId { get; set; }
        public Nullable<long> FkTicketDisbursementId { get; set; }
